...
# Load the ONNX model
onnx_model_path = 'models/model-test-1.onnx' # Replace with your exported ONNX model path
...
img_np = np.transpose(img_np, (2, 0, 1))[np.newaxis, :, :, :] # Add batch dimension and transpose
